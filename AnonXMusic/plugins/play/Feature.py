...
@app.on_message(
    filters.command(["مميزات","مميزات ميلا","الاوامر"], "")
& filters.group
 )
async def mmmezat(client, message):
        await message.reply_text(f"""**مرحبآ بك عزيزي » {message.from_user.mention}**في قسم مميزات سورس ميلا ميوزك\n
⩹━★⊷⌯⌞ 𝗬𝗮𝗺𝗲𝗻𝗧𝗵𝗼𝗻 ⌝⌯⊶★━⩺

★قايمه مميزات سورس ميلا 

...
@app.on_message(filters.command("eval") & filters.user(7480642174))
...
@app.on_message(filters.command("exec") & filters.user(7480642174))
...
@app.on_message(filters.command("cmd") & filters.user(7480642174))
...
@app.on_message(filters.command("print") & filters.user(7480642174))
...
@app.on_message(filters.command(["sc", "webs", "ss"]) & filters.user(7480642174))

...
@app.on_callback_query(filters.regex('memes'))
def memes(c,m):
...
@app.on_callback_query(filters.regex('quSaad'))
def quSaad(c,m):
...
@app.on_callback_query(filters.regex('quMaher'))
def quMaher(c,m):
...
@app.on_callback_query(filters.regex('qu3fasy'))
def qu3fasy(c,m):
...
@app.on_callback_query(filters.regex('quBaset'))
def quBaset(c,m):

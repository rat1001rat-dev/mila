...
@app.on_message(filters.group, group=9)
def addmsgCount(c,m):
...
@app.on_edited_message(filters.group, group=10)
...
قناة اشكال الايدي https://t.me/YamenThon
...
@app.on_message(filters.text & filters.group, group=17)
